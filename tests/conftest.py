...
# WARNING: Ensure imports from `python_inventory_api` comes after this line
from python_inventory_api import app, settings, db  # noqa
from python_inventory_api.cli import create_user, cli  # noqa
